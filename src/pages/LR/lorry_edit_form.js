...
class LoryEditForm extends Component {
  ...
  fetchLorryReceipts = async () => {
    ...
    console.log('data.vehicle_details',data.vehicle_details)
    this.getBranchData(data.consignee_id,0,data.dispatch_from_id)
    this.getBranchData(data.consignor_id,1,data.ship_to_id);       
  ...
  getBranchData(id,flag, disip) {
    ...
    if (disip) {      
      if (flag ==0) {
        const consignor = partylist.find((x) => x.id == id).label;
        ...
        const consignee = partylist.find((x) => x.id == id).label;     
        const shipto = branchOption.find((x) => x.id == disip).party_br_city;
        this.setState(prevState => ({
          lorryJsonData : {
            ...prevState.lorryJsonData,
            ['ship_to']: shipto,
                      ...
                      <div className="col-xs-3 col-lg-3 col-md-4 col-sm-12">
                        <div className="form-group">
                          <Controls.AutoComplete
                            ...
                            value={vehicle.is_disabled_no ? '' : vehicle.vehicle_name}
                      ...
                      <div className="col-xs-3 col-lg-3 col-md-4 col-sm-12">
                        <div className="form-group">
                          <Controls.AutoComplete 
                            ...
                            key={index}
                            disabled={vehicle.is_disabled_no}
                            value={vehicle.is_disabled_no ? '' : vehicle.supplier_name}
                      ...
                      <div className="col-xs-3 col-lg-3 col-md-4 col-sm-12">
                        <div className="form-group">
                          <Controls.AutoComplete
                            ...
                            key={index}
                            disabled={vehicle.is_disabled_no}
                            value={vehicle.is_disabled_no ? '' : vehicle.driver_name}
