...
class LoryJson extends Component {
  ...
  async fetchLorryJson() {
    try {
      ...
      //     party_doc_date: res.docDate ? res.docDate : '',
      //     consignor: res.fromTrdName ? res.fromTrdName : '',
      //     dispatch_address_line_1: res.fromAddr1 ? res.fromAddr1 : '',
      //     dispatch_address_line_1: res.fromAddr2 ? res.fromAddr2 : '',
      //     dispatch_address_line_3: res.fromPlace ? res.fromPlace : '',
      ...
      //     ship_address_line_1: res.toAddr2 ? res.toAddr2 : '',
      //     ship_address_line_3: res.toPlace ? res.toPlace : '',
        ...
        <form onSubmit={this.handleSubmit}>
          <div className="row my-4">
            ...
            <div className="col-md-3">
              <Controls.Button variant="contained" color="success" onClick={this.fetchLorryJson} text="Get Lorry Data" />
            </div>
          </div>
          <div className="row">
