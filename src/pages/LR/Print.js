...
class ComponentToPrint extends Component {
  ...
  render() {    
    ...
    const advance = this.props.data.advanceFields && this.props.data.advanceFields.length > 0 ? this.props.data.advanceFields[0]: []
    return (
        ...
        <div className="table-responsive">
          <table className="table table-bordered">
            ...
            { company &&               
              ...
              <tr className='text-center'>
                <td colSpan="3"><strong>Total Freight: </strong>{this.props.data.party_freight_total}</td>
                <td colSpan="3"><strong>Advance:</strong>{advance.advance_paid}</td>
                <td colSpan="2"><strong>Balance:</strong>{Number(this.props.data.party_freight_total-advance.advance_paid)}</td>
                <td colSpan="2"><strong>Remarks:</strong>{this.props.data.party_invoice_type}</td>
              </tr>
              <tr>
